"""!@file make_splits.py
@brief This file is used to create the 15 fold cross validation splits for extraction and alignment of multimodal data from GBMLGG dataset.
@author Shizhe Xu
@date 28 June 2024
"""
...
pickle.dump(
    data_dict,
    open(
        "%s/splits/gbmlgg15cv_%s_%d_%d_%d%s.pkl"
        % (
            opt.dataroot,
            opt.roi_dir,
            opt.ignore_missing_moltype,
