"""!@file main_conch.py
@brief This file is used to train and test the model using CONCH features.
@author Shizhe Xu
@date 28 June 2024
"""
...
from train_test_conch import train, test
...
data_cv_path = "%s/splits_conch/gbmlgg15cv_%s_%d_%d_%d%s.pkl" % (
    opt.dataroot,
    roi_dir,
