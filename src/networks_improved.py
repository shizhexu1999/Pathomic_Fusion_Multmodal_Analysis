"""!@file networks_improved.py
@brief It optimises the way of implement vgg19, and it uses the model from torchvision.models.
@author Shizhe Xu
@date 28 June 2024
"""
...
def get_vgg(
    ...
    **kwargs
    ...
    model = PathNet(
        vgg19_bn(weights=weights, progress=progress),
        act=act,
