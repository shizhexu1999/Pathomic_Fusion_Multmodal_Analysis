"""!@file IG_whole_data.py
@breif This file is used to do global explanation for the whole data, SNN, via Integrated Gradients.
@details This global explanation is applied to all patients without classifying them by the histomolecular subtypes.
@author Shizhe Xu
@date 28 June 2024
"""
...
plot_shap_style_integrated_gradients(
    ...
    save_folder="./visualisation_plots/",
    filename="gbmlgg_all_patients_shap_style_plot.png",
)
