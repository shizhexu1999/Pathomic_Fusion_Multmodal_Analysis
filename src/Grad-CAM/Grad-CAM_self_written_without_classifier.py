"""!@file Grad-CAM_self_written_without_classifier.py
...
The target layer we use is the last layer of the features encoder in the vgg19 model.
@author Shizhe Xu
@date 28 June 2024
"""
...
class GradCAM:
    ...
    def generate_cam(self, input_image, target_class=None):
        ...
        # we remove the classifier at this step
