"""!@file Grad-CAM_self_written.py
@breif This file is used to create the Grad-CAM using the vgg19 model from torchvision.models.
@details We use sef-written code to generate CAM, and the features are passing through the classifier.
@author Shizhe Xu
@date 28 June 2024
"""
...
class GradCAM:
    ...
    def generate_cam(self, input_image, target_class=None):
        ...
        # features are passing through the classifier
...
output_dir = 'Grad_CAM_self_written_code_vgg19'
os.makedirs(output_dir, exist_ok=True)
plt.imshow(cam_image)
plt.show()
cam_image_bgr = cv2.cvtColor(cam_image, cv2.COLOR_RGB2BGR)
output_path = os.path.join(output_dir, f'GradCAM_cam.jpg')
